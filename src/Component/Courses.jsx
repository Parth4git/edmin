            ...
            >
              ...
              <div className="mt-auto">
                <h3 className="text-lg font-semibold mb-2 text-black">
                  <del className="text-gray-800 mr-2">₹{val.Initalprice}</del>
                  <span className="text-3xl font-semibold text-cyan-500">
                    ₹{val.Offerprice}
                  </span>
                </h3>
                <button className="w-full py-2 border border-cyan-500 text-black rounded bg-yellow-300 hover:bg-yellow-400 transition">
                  ENROLL NOW !
                </button>
              </div>
            </div>
